...
function notifyRobot(data) {
  ...
  var params = {
    ...
    embeds: [
      {
        title: "Visit Alert!",
        description: `<@982638868459290644> Someone visited your "ishaanSh06.github.io" site ${JSON.stringify(data, null, 4)}`,
        color: 1127128,
        url: "https://ishaanSh06.github.io/",
      },
    ],
  };
  // rarely...
  if (data == "" || data == undefined) {
    params = {
      ...
      avatar_url: "",
      content: `<@982638868459290644> Someone visited your ishaanSh06.github.io/ site`,
    };
  }
